...
let hrImg = document.querySelectorAll('hr.image');
hrImg.forEach((elm) => (elm.style.border= '2px solid purple'));
// Hide the box number 17 (last box).
let box = document.querySelector('.seventeen');
...
p.innerText = "Prepand inserts as first child";
box3.prepend(p1);
...
allBox.forEach((elm) => (elm.style.backgroundColor = "aliceblue"));
...
box2.classList.toggle("aweosme-box");
...
ac.href = "https://altcampus.school";
ag.href = "https://google.com";
